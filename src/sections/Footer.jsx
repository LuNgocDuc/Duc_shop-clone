    ...
    <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[auto,auto,auto,auto,auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10'>
      <div data-aos= "zoom-in" data-aos-delay="200" className='flex flex-col justify-center items-start gap-10 grow'>
        <div className='flex flex-col justify-center items-start gap-4'>
          <h1 className='text-4xl font-bold text-themepurple underline italic'>Duc Shop</h1>
          <p className='text-gray-500 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. A tempore debitis temporibus assumenda magnam <br /> distinctio voluptates, pariatur rem sed fugiat, reprehenderit beatae.</p>
        </div>
        <div className='flex flex-col justify-center items-start gap-4'>
    ...
    <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100'>
      ...
      <div className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-4 gap-10'> 
        ...
        <div className='lg:w-[60%] w-full flex lg:flex-row flex-col justify-center items-center gap-4 flex-grow'>
          ...
          <div>
            <input type="email" placeholder='Enter valid email' className='lg:w-auto w-full capitalize px-6 py-3 rounded-lg'/>
            <button className='bg-themepurple lg:w-auto w-full text-white hover:bg-themeyellow hover:text-black px-6 py-3 rounded-r-lg'>SUBMIT</button>
          </div>
        </div>
        <div className='lg:w-[20%] w-full'>
          <p className='text-gray lg:text-end text-center'>2025 Powered by Debug Entity</p>
        </div>
      </div>
    </div>
    {/* 3st box ends here */}
